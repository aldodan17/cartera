...
Soy un analista de datos enfocado en transformar información en decisiones estratégicas. Combino análisis estadístico, visualización, experimentos A/B y automatización con Python y SQL. Además, cuento con experiencia operativa administrando puntos de venta, gestionando flujos de efectivo y optimizando procesos mediante datos.

🚀 Tecnologías que utilizo

Lenguajes: Python, SQL, R

Herramientas: Jupyter Notebook, VS Code, Excel avanzado

Librerías: Pandas, NumPy, Matplotlib, Seaborn, Plotly, SciPy

Bases de datos: PostgreSQL, MySQL, SQLite

Metodologías: A/B Testing, ETL básico, análisis exploratorio, modelado simple, estadísticas aplicadas
